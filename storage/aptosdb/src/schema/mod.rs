...
pub(crate) mod stale_state_value_index_with_key_hash;
pub(crate) mod state_value;
pub(crate) mod state_value_index;
pub(crate) mod state_value_with_key_hash;
...
pub const STALE_STATE_VALUE_INDEX_WITH_KEY_HASH_CF_NAME: ColumnFamilyName =
    "stale_state_value_index_with_key_hash";
pub const STATE_VALUE_CF_NAME: ColumnFamilyName = "state_value";
pub const STATE_VALUE_WITH_KEY_HASH_CF_NAME: ColumnFamilyName = "state_value_with_key_hash";
